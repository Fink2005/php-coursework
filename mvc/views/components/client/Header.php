<header class="z-50 fixed top-0 w-full h-16 border-b px-3 bg-[#0E1217] flex justify-between items-center">
    ...
    <div
        ...
        <svg width="1em" height="1em" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
            class="w-8 h-8 pointer-events-none mr-3 text-text-tertiary text-white">
            <path
        ...
        </svg><input data-search-panel-item="true" placeholder="Search" type="primary" autocomplete="off"
